...
with open(fn,'r') as f:
    ...
    input(f"Copied 1st initial prompt to the clipboard, press any key to copy next part")
    ...
    for idx in range(0, len(all_text), chunksize):
        ...
        input(f"Copied Part {count}/{total_chunks} to clipboard, press any key to copy next part")
